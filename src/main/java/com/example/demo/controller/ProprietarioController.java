...
public class ProprietarioController {
	...
	public ResponseEntity<ProprietarioDTO> CriarProprietario(@RequestBody ProprietarioDTO proprietario){
		 proprietario = serviceGeral.CriarProprietario();
		return new ResponseEntity<>(proprietario, HttpStatus.OK);
	}

	

	@PutMapping("/alterarProprietario")
	public ResponseEntity<ProprietarioDTO> AlterarProprietario(@RequestBody ProprietarioDTO proprietario){
		 proprietario = serviceGeral.AlterarProprietario();
		return new ResponseEntity<>(proprietario, HttpStatus.OK);
	}
	...
	public ResponseEntity<ProprietarioDTO> DeletarProprietario(@RequestBody ProprietarioDTO proprietario){
		 proprietario = serviceGeral.DeletarProprietario();
		return new ResponseEntity<>(proprietario, HttpStatus.OK);
	}
